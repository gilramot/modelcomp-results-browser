...
function DiseaseInfo() {
    ...
    const onFormChange = () => {
        ...
        if (prevValTest === 'A' && testRef.current.value !== 'A') trainRef.current.value = testRef.current.value;
        if (prevValTrain === 'A' && trainRef.current.value !== 'A') testRef.current.value = trainRef.current.value;
        if (prevValTrain !== 'A' && trainRef.current.value === 'A') testRef.current.value = 'A';
        if (prevValTest !== 'A' && testRef.current.value === 'A') trainRef.current.value = 'A';
        ...
        if ((modelValue === 'Random%20Forest' || modelValue === 'XGBoost') && trainValue === testValue) {
        ...
        if (trainValue === testValue) {
            ...
            shapRef.current.src = transparent;
            document.getElementById('shap-title').innerText = '';
        }
        prevValTrain = trainValue;
        prevValTest = testValue;
    }
            ...
            <div className='form'>
                <div className='select'>
                    ...
                    <select id='train' onChange={onFormChange} ref={trainRef}>
                        ...
                        <option value='A'>All diseases</option>
